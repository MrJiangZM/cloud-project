...
public class Payment8010Controller {
...
//    private PaymentService paymentService;
    ...
    public CommonResult<Payment> findById(Long id) {
        ...
        return new CommonResult<>(200, serverPort, new Payment(100L, "testSerial22222"));
    }
    ...
    public CommonResult<Object> service(Long id) {
        ...
        return new CommonResult<>(200, serverPort, new Payment(200L, "testSerial222222"));
    }
